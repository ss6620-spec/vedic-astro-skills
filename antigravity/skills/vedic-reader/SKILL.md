...
### Step 4.5: 行星快照（静默，不输出给用户）

**在Step 5验前事之前，静默执行一轮mini分析，提升验前事推断的精度。**
**此步骤的输出写入structured_data.md，不展示给用户。**

对以下4颗关键行星，执行5层审计 + 燃烧检查 + 快速Yoga扫描：

```
选哪4颗行星：
  ① L1（命主星）     → 影响性格/体质/人生基调推断
  ② L10（事业宫主）   → 影响职业/社会角色推断
  ③ L7 或 DK         → 影响婚姻/感情推断（优先选DK，无争议时选L7）
  ④ Shadbala最高的行星 → 影响人生主旋律推断（如与①②③重复则选次高）

每颗行星做5项检查：
  P1 角色身份：Core-Driver / Yogakaraka / Faithful / Trader / Growth-Hacker / Destroyer
  P5 落宫性质：吉路(1/4/5/7/9/10) / 6宫(50%) / 8宫(30%) / 12宫(20%)
  P7 尊贵度：入旺/入庙/友方/中性/敌方/落陷
  P4 掌宫SAV：该星管理的宫位SAV数值
  P6 落宫SAV：该星实际所在宫位SAV数值
...
**输出格式（写入structured_data.md的预分析区域）**：

```
行星快照：
| 行星 | 角色(P1) | 落宫(P5) | 尊贵度(P7) | 掌宫SAV | 落宫SAV | 燃烧 | 一句话 |
|------|---------|---------|-----------|--------|--------|------|-------|
| [L1] | [...] | [...] | [...] | [...] | [...] | [—/⚠️X°] | [...] |
| [L10]| [...] | [...] | [...] | [...] | [...] | [—/⚠️X°] | [...] |
| [DK] | [...] | [...] | [...] | [...] | [...] | [—/⚠️X°] | [...] |
...
Yoga速查：[检测到的Yoga列表，或"未检测到主要Yoga"]

验前事增强备注：
  - [基于快照得出的2-3条高置信度推断方向]
```

**"一句话"列的写法**：综合P1+P5+P7+SAV+燃烧，用一句话说明这颗行星在这张盘里"意味着什么"。
